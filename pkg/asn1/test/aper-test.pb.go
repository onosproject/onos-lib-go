...
func (x *TestChoices) GetChoice2B() int32 {
...
func (x *TestChoices) GetChoice3B() int32 {
...
func (x *TestChoices) GetChoice3C() int32 {
...
type TestChoices_Choice2B struct {
	...
	Choice2B int32 `protobuf:"varint,21,opt,name=choice2B,proto3,oneof" aper:"choiceIdx:2,valueExt"`
}
...
type TestChoices_Choice3B struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	Choice3B int32 `protobuf:"varint,31,opt,name=choice3B,proto3,oneof" aper:"choiceIdx:2,valueExt"`
}

type TestChoices_Choice3C struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	Choice3C int32 `protobuf:"varint,32,opt,name=choice3C,proto3,oneof" aper:"choiceIdx:3,valueExt"`
}
...
var file_pkg_asn1_test_aper_test_proto_rawDesc = []byte{
	...
	0x08, 0x63, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x32, 0x42, 0x18, 0x15, 0x20, 0x01, 0x28, 0x05, 0x48,
	...
	0x69, 0x63, 0x65, 0x33, 0x42, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x05, 0x48, 0x02, 0x52, 0x08, 0x63,
	0x68, 0x6f, 0x69, 0x63, 0x65, 0x33, 0x42, 0x12, 0x1c, 0x0a, 0x08, 0x63, 0x68, 0x6f, 0x69, 0x63,
	0x65, 0x33, 0x43, 0x18, 0x20, 0x20, 0x01, 0x28, 0x05, 0x48, 0x02, 0x52, 0x08, 0x63, 0x68, 0x6f,
