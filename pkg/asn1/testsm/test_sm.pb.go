...
type TestUnconstrainedReal struct {
	...
	AttrUcrA float32 `protobuf:"fixed32,1,opt,name=attr_ucr_a,json=attrUcrA,proto3" json:"attr_ucr_a,omitempty"`
...
func (x *TestUnconstrainedReal) GetAttrUcrA() float32 {
	if x != nil {
		return x.AttrUcrA
	}
	return 0
...
type TestConstrainedReal struct {
	...
	// @inject_tag: aper:"valueLB:10,valueUB:100"
	AttrCrA float32 `protobuf:"fixed32,1,opt,name=attr_cr_a,json=attrCrA,proto3" json:"attr_cr_a,omitempty" aper:"valueLB:10,valueUB:100"`
	// @inject_tag: aper:"valueLB:10"
	AttrCrB float32 `protobuf:"fixed32,2,opt,name=attr_cr_b,json=attrCrB,proto3" json:"attr_cr_b,omitempty" aper:"valueLB:10"`
	// @inject_tag: aper:"valueUB:100"
	AttrCrC float32 `protobuf:"fixed32,3,opt,name=attr_cr_c,json=attrCrC,proto3" json:"attr_cr_c,omitempty" aper:"valueUB:100"`
	// @inject_tag: aper:"valueLB:10,valueUB:20"
	AttrCrD float32 `protobuf:"fixed32,4,opt,name=attr_cr_d,json=attrCrD,proto3" json:"attr_cr_d,omitempty" aper:"valueLB:10,valueUB:20"`
	// @inject_tag: aper:"valueLB:10,valueUB:10"
	AttrCrE float32 `protobuf:"fixed32,5,opt,name=attr_cr_e,json=attrCrE,proto3" json:"attr_cr_e,omitempty" aper:"valueLB:10,valueUB:10"`
	// @inject_tag: aper:"valueLB:10,valueUB:10,valueExt"
	AttrCrF float32 `protobuf:"fixed32,6,opt,name=attr_cr_f,json=attrCrF,proto3" json:"attr_cr_f,omitempty" aper:"valueLB:10,valueUB:10,valueExt"`
}
...
func (x *TestConstrainedReal) GetAttrCrA() float32 {
	if x != nil {
		return x.AttrCrA
	}
	return 0
...
func (x *TestConstrainedReal) GetAttrCrB() float32 {
	if x != nil {
		return x.AttrCrB
	}
	return 0
...
func (x *TestConstrainedReal) GetAttrCrC() float32 {
	if x != nil {
		return x.AttrCrC
	}
	return 0
...
func (x *TestConstrainedReal) GetAttrCrD() float32 {
	if x != nil {
		return x.AttrCrD
	}
	return 0
...
func (x *TestConstrainedReal) GetAttrCrE() float32 {
	if x != nil {
		return x.AttrCrE
	}
	return 0
...
func (x *TestConstrainedReal) GetAttrCrF() float32 {
	if x != nil {
		return x.AttrCrF
	}
	return 0
...
type TestConstrainedChoices struct {
	...
	//    string other_cattr = 1 [(validate.v1.rules).string = {min_len: 1, max_len: 50}, json_name="otherCAttr"];
...
type TestOctetString struct {
	...
	//    bytes attr_os2 = 2 [(validate.v1.rules).bytes.len = 20, json_name="attrOs2"];
	...
	//    bytes attr_os3 = 3 [(validate.v1.rules).bytes.len = 127, json_name="attrOs3"];
...
type TestPrintableString struct {
	...
	//    string attr_ps2 = 2 [(validate.v1.rules).string = {min_len: 20, max_len: 20}, json_name="attrPs2"];
	// @inject_tag: aper:"sizeLB:127,sizeUB:127,sizeExt"
	...
	//    string attr_ps3 = 3 [(validate.v1.rules).string = {min_len: 127, max_len: 127}, json_name="attrPs3"];
	// @inject_tag: aper:"sizeLB:0,sizeUB:32"
	AttrPs4 string `protobuf:"bytes,4,opt,name=attr_ps4,json=attrPs4,proto3" json:"attr_ps4,omitempty" aper:"sizeLB:0,sizeUB:32"`
	//    string attr_ps4 = 4 [(validate.v1.rules).string = {min_len: 0, max_len: 32}, json_name="attrPs4"];
	// @inject_tag: aper:"sizeLB:22,sizeUB:32"
	AttrPs5 string `protobuf:"bytes,5,opt,name=attr_ps5,json=attrPs5,proto3" json:"attr_ps5,omitempty" aper:"sizeLB:22,sizeUB:32"`
	//    string attr_ps5 = 5 [(validate.v1.rules).string = {min_len: 22, max_len: 32}, json_name="attrPs5"];
	// @inject_tag: aper:"sizeLB:28,sizeUB:32,sizeExt"
	...
	//    string attr_ps6 = 6 [(validate.v1.rules).string = {min_len: 28, max_len: 32}, json_name="attrPs6"];
	// @inject_tag: aper:"optional,sizeLB:22,sizeUB:36"
	AttrPs7 *string `protobuf:"bytes,7,opt,name=attr_ps7,json=attrPs7,proto3,oneof" json:"attr_ps7,omitempty" aper:"optional,sizeLB:22,sizeUB:36"` //    optional string attr_ps7 = 7 [(validate.v1.rules).string = {min_len: 22, max_len: 36}, json_name="attrPs7"];
}
...
var file_pkg_asn1_testsm_test_sm_proto_rawDesc = []byte{
	...
	0x72, 0x55, 0x63, 0x69, 0x42, 0x22, 0xbc, 0x01, 0x0a, 0x12, 0x54, 0x65, 0x73, 0x74, 0x43, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x4a, 0x0a, 0x09, 0x54, 0x65, 0x73, 0x74, 0x4c,
	0x69, 0x73, 0x74, 0x33, 0x12, 0x3d, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x2e,
	...
	0x45, 0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x36, 0x10, 0x05, 0x42, 0x11, 0x5a, 0x0f, 0x70, 0x6b, 0x67,
	0x2f, 0x61, 0x73, 0x6e, 0x31, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x73, 0x6d, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pkg_asn1_testsm_test_sm_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_asn1_testsm_test_sm_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_pkg_asn1_testsm_test_sm_proto_goTypes = []interface{}{
	...
	(*TestUnconstrainedInt)(nil),      // 2: aper.test.v1.TestUnconstrainedInt
	(*TestConstrainedInt)(nil),        // 3: aper.test.v1.TestConstrainedInt
	(*TestUnconstrainedReal)(nil),     // 4: aper.test.v1.TestUnconstrainedReal
	(*TestConstrainedReal)(nil),       // 5: aper.test.v1.TestConstrainedReal
	(*TestBitString)(nil),             // 6: aper.test.v1.TestBitString
	(*TestChoices)(nil),               // 7: aper.test.v1.TestChoices
	(*Choice1)(nil),                   // 8: aper.test.v1.Choice1
	(*Choice2)(nil),                   // 9: aper.test.v1.Choice2
	(*Choice3)(nil),                   // 10: aper.test.v1.Choice3
	(*Choice4)(nil),                   // 11: aper.test.v1.Choice4
	(*TestConstrainedChoices)(nil),    // 12: aper.test.v1.TestConstrainedChoices
	(*ConstrainedChoice1)(nil),        // 13: aper.test.v1.ConstrainedChoice1
	(*ConstrainedChoice2)(nil),        // 14: aper.test.v1.ConstrainedChoice2
	(*ConstrainedChoice3)(nil),        // 15: aper.test.v1.ConstrainedChoice3
	(*ConstrainedChoice4)(nil),        // 16: aper.test.v1.ConstrainedChoice4
	(*TestOctetString)(nil),           // 17: aper.test.v1.TestOctetString
	(*TestPrintableString)(nil),       // 18: aper.test.v1.TestPrintableString
	(*TestList1)(nil),                 // 19: aper.test.v1.TestList1
	(*Item)(nil),                      // 20: aper.test.v1.Item
	(*TestList2)(nil),                 // 21: aper.test.v1.TestList2
	(*ItemExtensible)(nil),            // 22: aper.test.v1.ItemExtensible
	(*TestFullyOptionalSequence)(nil), // 23: aper.test.v1.TestFullyOptionalSequence
	(*TestListExtensible1)(nil),       // 24: aper.test.v1.TestListExtensible1
	(*TestListExtensible2)(nil),       // 25: aper.test.v1.TestListExtensible2
	(*TestListExtensible3)(nil),       // 26: aper.test.v1.TestListExtensible3
	(*TestList3)(nil),                 // 27: aper.test.v1.TestList3
	(*asn1.BitString)(nil),            // 28: asn1.v1.BitString
}
var file_pkg_asn1_testsm_test_sm_proto_depIdxs = []int32{
	28, // 0: aper.test.v1.TestBitString.attr_bs1:type_name -> asn1.v1.BitString
	28, // 1: aper.test.v1.TestBitString.attr_bs2:type_name -> asn1.v1.BitString
	28, // 2: aper.test.v1.TestBitString.attr_bs3:type_name -> asn1.v1.BitString
	28, // 3: aper.test.v1.TestBitString.attr_bs4:type_name -> asn1.v1.BitString
	28, // 4: aper.test.v1.TestBitString.attr_bs5:type_name -> asn1.v1.BitString
	28, // 5: aper.test.v1.TestBitString.attr_bs6:type_name -> asn1.v1.BitString
	28, // 6: aper.test.v1.TestBitString.attr_bs7:type_name -> asn1.v1.BitString
	8,  // 7: aper.test.v1.TestChoices.choice1:type_name -> aper.test.v1.Choice1
	9,  // 8: aper.test.v1.TestChoices.choice2:type_name -> aper.test.v1.Choice2
	10, // 9: aper.test.v1.TestChoices.choice3:type_name -> aper.test.v1.Choice3
	11, // 10: aper.test.v1.TestChoices.choice4:type_name -> aper.test.v1.Choice4
	13, // 11: aper.test.v1.TestConstrainedChoices.constrained_choice1:type_name -> aper.test.v1.ConstrainedChoice1
	14, // 12: aper.test.v1.TestConstrainedChoices.constrained_choice2:type_name -> aper.test.v1.ConstrainedChoice2
	15, // 13: aper.test.v1.TestConstrainedChoices.constrained_choice3:type_name -> aper.test.v1.ConstrainedChoice3
	16, // 14: aper.test.v1.TestConstrainedChoices.constrained_choice4:type_name -> aper.test.v1.ConstrainedChoice4
	20, // 15: aper.test.v1.TestList1.value:type_name -> aper.test.v1.Item
	28, // 16: aper.test.v1.Item.item2:type_name -> asn1.v1.BitString
	22, // 17: aper.test.v1.TestList2.value:type_name -> aper.test.v1.ItemExtensible
	20, // 18: aper.test.v1.TestListExtensible1.value:type_name -> aper.test.v1.Item
	22, // 19: aper.test.v1.TestListExtensible2.value:type_name -> aper.test.v1.ItemExtensible
	23, // 20: aper.test.v1.TestListExtensible3.value:type_name -> aper.test.v1.TestFullyOptionalSequence
	23, // 21: aper.test.v1.TestList3.value:type_name -> aper.test.v1.TestFullyOptionalSequence
...
func file_pkg_asn1_testsm_test_sm_proto_init() {
	...
	file_pkg_asn1_testsm_test_sm_proto_msgTypes[18].OneofWrappers = []interface{}{}
	file_pkg_asn1_testsm_test_sm_proto_msgTypes[20].OneofWrappers = []interface{}{}
